...
/**
 * {@link ContentProvider} for Inventory app stage 2.
 */
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryappstage2/books" will map to the
        ...
        // For example, "content://com.example.android.inventoryappstage2/books/3" matches, but
        // "content://com.example.android.inventoryappstage2/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoryappstage2/books/3",
