...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * Button that extracts 1 from quantity
     */
    private Button mMinusButton;

    /**
     * Button that adds 1 to quantity
     */
    private Button mPlusButton;

    /**
     * Button that calls supplier phone
     */
    private Button mCallSupplierButton;

    /**
     * Quantity of the book. Default 0.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMinusButton = findViewById(R.id.minus_quantity_button);
        mPlusButton = findViewById(R.id.plus_quantity_button);
        ...
        mMinusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mQuantity>0) {
                    ...
                    Toast.makeText(EditorActivity.this, getString(R.string.quantity_warning_message), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void saveBook() {
        ...
        // and check if all the fields in the editor are filled
        if (TextUtils.isEmpty(nameString) || TextUtils.isEmpty(quantityString) || TextUtils.isEmpty(priceString) ||
            ...
            // Since one or more fields are not modified, we can return early without creating a new book.
            // No need to create ContentValues and no need to do any ContentProvider operations.
            Toast.makeText(this, getString(R.string.editor_empty_value_warning),
